...
},
{
    ...
    return (
        ...
        <VStack spacing={5} py="10">
            <Text as="div" color="#aaaaaa"> 
            <Box color="blue.500"  as="span" position={'relative'} fontSize="xl">
            <Box as="span" bottom="3" right="0" position="absolute" >$</Box></Box>
            <Box fontWeight="bold"  as="span" color="blue.500" fontSize="4xl">
               {val.price}</Box> / {val.interval}</Text>
        ...
        <Flex justifyContent={'center'} alignItems="center" bg="#f1f1f1f1" py="15px">
            <Button bg="blue.500" color="white" rounded="full">Get Demo</Button>
        </Flex>
